...
class CornellWordChatBot(object):
    ...
    def __init__(self):
        self.input_word2idx = np.load('../chatbot_train/models/cornell/word-input-word2idx.npy',
                                      allow_pickle=True).item()
        self.input_idx2word = np.load('../chatbot_train/models/cornell/word-input-idx2word.npy',
                                      allow_pickle=True).item()
        self.target_word2idx = np.load('../chatbot_train/models/cornell/word-target-word2idx.npy',
                                       allow_pickle=True).item()
        self.target_idx2word = np.load('../chatbot_train/models/cornell/word-target-idx2word.npy',
                                       allow_pickle=True).item()
        context = np.load('../chatbot_train/models/cornell/word-context.npy', allow_pickle=True).item()

...
class GunthercoxCharChatBot(object):
    ...
    def __init__(self):
        self.input_char2idx = np.load('../chatbot_train/models/gunthercox/char-input-char2idx.npy',
                                      allow_pickle=True).item()
        print(self.input_char2idx)
        self.input_idx2char = np.load('../chatbot_train/models/gunthercox/char-input-idx2char.npy',
                                      allow_pickle=True).item()
        self.target_char2idx = np.load('../chatbot_train/models/gunthercox/char-target-char2idx.npy',
                                       allow_pickle=True).item()
        self.target_idx2char = np.load('../chatbot_train/models/gunthercox/char-target-idx2char.npy',
                                       allow_pickle=True).item()
        context = np.load('../chatbot_train/models/gunthercox/char-context.npy', allow_pickle=True).item()
